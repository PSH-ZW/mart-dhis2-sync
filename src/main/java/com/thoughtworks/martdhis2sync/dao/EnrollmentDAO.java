...
public class EnrollmentDAO {
    ...
    public String getOldestProgramEnrolmentDateForPatient(Integer patientId) {
        ...
        try{
            String patientCreateDate = jdbcTemplate.queryForObject(patientCreatedDateSql, String.class, patientId);
            return getFormattedDateString(patientCreateDate, DATEFORMAT_WITH_24HR_TIME, DATEFORMAT_WITHOUT_TIME);
        } catch (DataAccessException e) {
            e.printStackTrace();
        }
        return "";
