...
public class PsiRowMapper extends ColumnMapRowMapper {
    ...
    public Map<String, Object> mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        Set<String> specialFields = Stream.of("encounter_id", "visit_id", "patient_id", "patient_identifier",
        ...
        for(int i = 1; i <= columnCount; ++i) {
            ...
            if(!tableName.equals(Constants.PATIENT_TABLE_NAME) && !specialFields.contains(key)) {
                key = tableName + "_" + key;
            }
