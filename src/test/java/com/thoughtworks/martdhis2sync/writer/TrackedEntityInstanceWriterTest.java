...
//        setValuesForMemberFields(writer, "loggerService", loggerService);
    ...
    public void shouldLogMissingOrgUnitInTheDHISServerAndSaveImportedTEIButNotUpdateMarkerAndThrowExceptionWhenSyncReturns200StatusWithConflictsInResponse() {
        String conflictValue = "No org unit ID in tracked entity instance object";
        List<Conflict> conflicts = Collections.singletonList(new Conflict(null, conflictValue));
